...
def detect_video(yolo, video_path, output_path=""):
    ...
    while True:
        if zed.grab(runtime_params)==tp.PyERROR_CODE.PySUCCESS:
            ...
            frame0=frame0[0:width,round(height/2):height]
            ...
            global locX,locY
            #depth_value=depth.get_value(locX,locY)
            depth_value=depth.get_value(locX,locY)
            #distance=math.sqrt(point_cloud_value[0]*point_cloud_value[0]+point_cloud_value[1]*point_cloud_value[1]+point_cloud_value[2]*point_cloud_value[2])
            
            camera_x=float(depth_value*locX-depth_value*frame.size[0]//2)//349.614
            camera_y=float(depth_value*locY-depth_value*frame.size[1]//2)//349.614
            camera_z=depth_value
            distance=camera_x*camera_x+camera_y*camera_y+camera_z*camera_z
            #msg=StringIO.StringIO()
            class_list=["blue cone","red cone","yellow cone"]
            global Class
